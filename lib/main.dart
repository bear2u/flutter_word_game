...
class RandomSentences extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return new _RandomSentenceState();
  }
}

class _RandomSentenceState extends State<StatefulWidget> {
  ...
  Widget _buldSentences() {
    return new ListView.builder(
      ...
      itemBuilder: (context, i) {
        ...
        final index = i ~/ 2;
        print("index = $index, sentence length = ${_sentences.length}");
